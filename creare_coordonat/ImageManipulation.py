...
class ImageManipulation:
    ...
    def draw_function(self, *image_copy):
        ...
        if self.update_only_second is False:
            for i, k in enumerate(self._face_one.points):
                ...
                for j in range(len(image_copy)):
                    ...
                    if j % 2 == 0:
                        ...
                        cv2.circle(image_copy[j], (x_p2, y_p2), 10, color, -1)
                        cv2.imshow(self._face_two.window_name if j == 1 else self._face_end.window_name,
                                   image_copy[j])

                # cv2.circle(for image_copy in image_copy, (x_p1, y_p1), 5, color, -1)
            ...
            for i, k in enumerate(self._face_two.points):
                ...
                cv2.circle(image_copy[3], (x, y), 10, color, -1)
    ...
    def draw_points(self):
        ...
        self.draw_function(image1_copy, image2_copy, image_start_copy, image_end_copy)
