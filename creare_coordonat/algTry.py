...
class ImageZoomApp:
    def __init__(self, root):
        ...
        self.load_image(r"C:\Users\mflor\Desktop\Licenta\poze_initiale\face11.jpg")
    ...
    def zoom_in(self, event=None):
        ...
        self.image = self.image.resize((int(self.image.width * 1.2), int(self.image.height * 1.2)), Image.Resampling.LANCZOS)
        self.tk_image = ImageTk.PhotoImage(self.image)
    ...
    def zoom_out(self, event=None):
        ...
        self.image = self.image.resize((int(self.image.width * 0.8), int(self.image.height * 0.8)), Image.Resampling.LANCZOS)
        self.tk_image = ImageTk.PhotoImage(self.image)
        self.canvas.delete("all")
        self.canvas.create_image(0, 0, anchor=tk.NW, image=self.tk_image)
...
# t = SysManipulation.load_from_folder("First face")
